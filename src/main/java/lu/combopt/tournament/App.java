...
public class App {
    ...
    public static void generateProblems(){
        ...
        TournamentSchedule problem_small = generateDataSmall();
        TournamentSchedule problem_medium = generateDataMedium();
        TournamentSchedule problem_big = generateDataBig();
        ...
        objIO.write(problem_small, new File("data/problem_small.json"));
        objIO.write(problem_medium, new File("data/problem_medium.json"));
        objIO.write(problem_big, new File("data/problem_big.json"));
    }
    ...
    public static TournamentSchedule generateData2(){
        ...
        Stadium stadCamp = new Stadium("Camp Nou");
        Stadium stadAnf= new Stadium("Anfield");
        Stadium stadPark = new Stadium("Park de Prance");
        ...
        List<Stadium> stadiumList = List.of(stadStam, stadCamp , stadAnf, stadSan, stadPark, stadOld, stadSant);

        Team teamBarc = new Team("Barcelona", stadCamp);
        Team teamLiv = new Team("Liverpool", stadAnf);
        Team teamInt = new Team("Inter", stadSan);
        Team teamMil = new Team("Milan", stadSan);
        Team teamPsg = new Team("PSG", stadPark);
    ...
    public static TournamentSchedule generateDataBig(){
        List<DateTimeSlot> dateTimeSlotList = new LinkedList<>();
        Integer id = 1;
        for(int day = 1; day <= 31; day++){
            for(int startTime = 8; startTime <= 22; startTime += 2){
    ...
    public static TournamentSchedule generateDataMedium(){
        List<DateTimeSlot> dateTimeSlotList = new LinkedList<>();
        Integer id = 1;
        for(int day = 1; day <= 31; day++){
            for(int startTime = 10; startTime <= 20; startTime += 2){
                dateTimeSlotList.add(new DateTimeSlot(id++, LocalDateTime.of(2023, Month.MAY, day, startTime, 0, 0)));
            }
        }
        ...
        List<Stadium> stadiumList = List.of(stadCamp , stadAnf, stadSan, stadPark);
        ...
        Team teamMil = new Team("Milan", stadSan);
        Team teamPsg = new Team("PSG", stadPark);
        List<Team> teamList = List.of(teamBarc, teamInt, teamMil, teamLiv, teamPsg);
    ...
    public static TournamentSchedule generateDataSmall(){
        List<DateTimeSlot> dateTimeSlotList = new LinkedList<>();
        Integer id = 1;
        for(int day = 1; day <= 7; day++){
            for(int startTime = 16; startTime <= 20; startTime += 2){
                dateTimeSlotList.add(new DateTimeSlot(id++, LocalDateTime.of(2023, Month.MAY, day, startTime, 0, 0)));
            }
        }
        ...
        List<Stadium> stadiumList = List.of(stadCamp, stadSan);

        Team teamBarc = new Team("Barcelona", stadCamp);
        Team teamInt = new Team("Inter", stadSan);
        Team teamMil = new Team("Milan", stadSan);
        List<Team> teamList = List.of(teamBarc, teamInt, teamMil);
